      ...
      <div className="container px-4 mx-auto about">
        <div className="lg:flex -mx-4">
          <div className="lg:w-2/3 px-4 about-animated">
            ...
            <p className="lead" itemProp="description">Hi, I’m Kevin, and I started my freelance web design/development business, <span itemProp="legalName">Vitamin Digital Media LLC</span>, in 2012. And here’s my brief background.</p>
            <p className="mb-3">When I attended Stuyvesant High School in Manhattan, I received good grades in math. (I completed AP (BC) Calculus in my junior year and missed perfect score in math SAT by just one question.) But I wasn’t into the robotics team like those who go on to become real engineers. I cared about other kids’ opinions of me. I liked to dress nice clothes and downplayed school in front of peers.</p>
            <p className="mb-3">Many years later, when I enrolled in a graduate professional writing program, a professor who worked at IBM came to the program and started web content development concentration suited for the digital economy. I loved the experience of building websites out of code, so I took all the courses on web design and development and made a habit of reading web programming books and practicing coding whenever I had time. After I graduated with a 4.0 GPA, I studied, freelanced, and contracted for the past 8 years. I built websites that small businesses or other web agencies were willing to pay for. And I’m now learning to make my websites pay more attention to the website users’ opinions of my websites and digital marketing efforts, so that I can adjust and make my websites better-looking, more enjoyable, and most importantly, more useful to the visitors. (And now I have much more respect for &quot;real engineers,&quot; as I learned that elegance isn&#x27;t just about how things look.)</p>
            <div className="social-buttons">
              ...
              <a className="social-button" href="https://github.com/kevink520" target="_blank" rel="noopener noreferrer">

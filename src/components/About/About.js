        ...
        <div className='lg:flex -mx-4'>
          <div className='lg:w-2/3 px-4 about-animated'>
            <h2 className='about-heading'>About <span className='orange'>Vitamin</span> Digital Media</h2>
                <p className='lead' itemProp='description'>Hi, I&rsquo;m Kevin, and I&rsquo;m a full stack developer with more than 10 years of experience. And here’s my brief background.</p>
            ...
            <div className='social-buttons flex'>
              ...
              <a className='social-button' href='https://www.freecodecamp.org/kevink520' target='_blank' rel='noopener noreferrer'>

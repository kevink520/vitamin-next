          ...
          <div className='lg:w-1/2 px-4 service wp-theme' itemProp='makesOffer' itemScope itemType='http://schema.org/Offer'>
            <div className='md:flex -mx-4'>
              <div className='md:w-1/2 px-4 mb-4 md:mb-0 service-header'>
                <h3 className='service-title'>Next.js web app development</h3>
                <EcommerceSVG />
              </div>
              <div className='flex flex-col justify-center md:w-1/2 px-4'>
                <p className='service-description'>Next.js is a highly performant, modern framework for building full stack web apps. I can build a Next.js web app paired with a headless CMS such as Sanity.io or WordPress.</p>
              </div>
            </div>
          </div>
          <div className='lg:w-1/2 px-4 service wp-theme' itemProp='makesOffer' itemScope itemType='http://schema.org/Offer'>
            <div className='md:flex -mx-4'>
              ...
              <div className='flex flex-col justify-center md:w-1/2 px-4'>
                <p className='service-description'>WordPress is the world&rsquo;s most popular content management system (CMS), used by major brands including Sony Music and Time Magazine.  I can turn any design into a fully editable, responsive website using WordPress.</p>
              </div>
            </div>
          </div>
        </div>
